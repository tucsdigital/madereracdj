    ...
    <Card>
      ...
      <CardContent className="px-7 mt-5 space-y-6">
        ...
        <div className="grid grid-cols-12 items-center gap-5">
          ...
          <div className="col-span-12 md:col-span-9">
            <Flatpickr
              className="w-full bg-background border border-default-300 pl-3 text-default-500 placeholder:text-default-500 text-sm   focus:outline-hidden h-10 rounded-md px-2 "
