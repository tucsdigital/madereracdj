...
const ChatBox = ({ onClose }) => {
  ...
  return (
    <Card className="fixed z-[999] bottom-0 ltr:right-4 rtl:left-4 w-[200px] md:[250px] lg:w-[360px]  rounded-t-md rounded-b-none border border-border dark:border-t-0">
      <CardHeader
            ...
            <form>
              <div className="flex  gap-1 relative">
                <textarea
                  ...
                  className="bg-default-200 outline-hidden border border-border hover:border-primary rounded-xl break-words px-3 flex-1 h-10 pt-2 p-1 "
                  style={{
                    minHeight: "40px",
                    maxHeight: "70px",
                    overflowY: "auto",
