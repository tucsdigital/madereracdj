    ...
    >
      <CardHeader className="border-none p-0 block mb-0">
        <div className="py-3.5 px-6 bg-primary/10 rounded-t-md flex gap-3">
          ...
          <button type="button" className="flex-none cursor-pointer" onClick={handleMinimize}>
            <Minus className="h-5 w-5 text-default-500" />
          </button>
          <button
            type="button"
            className="flex-none hidden lg:block cursor-pointer"
            onClick={handleMaximize}
          >
            <Minimize2 className="h-5 w-5 text-default-500" />
          </button>
          <button type="button" className="flex-none cursor-pointer" onClick={onClose}>
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="relative h-11 border-b border-border flex items-center ">
            <label
              htmlFor="recepients"
            ...
            <input
              ...
              type="text"
              id="recepients"
              className="w-full bg-background border-none focus:outline-hidden pl-2"
            />
          </div>
          <div className="mb-7">
            <input
              {...register("subject")}
              type="text"
              className="w-full bg-background  focus:outline-hidden h-11 border-b border-border text-sm placeholder:text-default-500 text-default-600"
              placeholder="Subject"
            />
          </div>

          <div
            className="snow-editor border border-border h-[250px]"
            ref={quillRef}
          ></div>
