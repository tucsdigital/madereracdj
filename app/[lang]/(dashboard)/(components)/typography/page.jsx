  ...
  return (
    <div>
      <Card className="h-full p-6 space-y-7">
        ...
        <hr className="text-border -mx-6" />
        {displayTableHeading.map((data1st, index) => (
          <div key={index} className="w-full mt-0!">
            <div className="border-0 border-border border-b-[1px]! ">
            ...
            {data1st.tableData.map((data, index) => (
              <div key={index} className="border-0">
                <div className="border-0 border-b-[1px]! border-border flex flex-wrap items-center">
        ...
        {displayTableBody.map((data1st, index) => (
          <div key={index} className="w-full mt-0!">
            <div className="border-0 border-b-[1px]! border-border">
              <div className="font-semibold text- text-2xl py-6">
                {data1st.tableHeader}
              </div>
            </div>
