    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 px-3.5 py-6 gap-6">
      {
        posts.map((item, index) => (
          <Link
            ...
            href={item.link}
          >
            <div className="h-[220px] lg:h-[292px] rounded-md before:rounded-md relative before:absolute before:top-0 before:left-0 before:w-full before:h-full group-hover:before:bg-default-900/30">
