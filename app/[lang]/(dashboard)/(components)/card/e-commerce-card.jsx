          ...
          <Link href="#">
            <div className=" relative h-[191px] flex flex-col justify-center items-center mb-3 rounded-md">
              <div className="w-full overflow-hidden rounded-md relative z-10 bg-default-100 dark:bg-default-200 h-full ">
                <Image
                  alt=""
                  className=" size-full  object-contain p-6   transition-all duration-300 group-hover:scale-105"
                  src={ecard1}
                />
                <Badge
                  color="destructive"
                ...
                <div className="hover-box flex flex-col invisible absolute top-3 ltr:right-2 rtl:left-2 opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-300 space-y-[6px]">
                  <button className="rounded-full bg-background p-2 cursor-pointer">
                    <Icon
                      icon="ph:heart-fill"
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex-1 space-x-4 rtl:space-x-reverse items-center ">
                <div className="flex-1 h-10 flex border border-solid border-primary delay-150 ease-in-out  ltr:divide-x-[1px] rtl:divide-x-reverse text-sm font-normal divide-primary rounded">
                  <button
                    type="button"
                    className="flex-none px-4 text-primary hover:bg-primary hover:text-primary-300  disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer"
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex-auto ltr:space-x-4 rtl:space-x-reverse items-center ">
                <div className="flex-1 ltr:space-x-4 rtl:space-x-reverse items-center ">
                  <div className="flex-1 h-10 flex border border-solid border-primary delay-150 ease-in-out  divide-x-[1px] rtl:divide-x-reverse text-sm font-normal divide-primary rounded">
                    <button
                      type="button"
                      className="flex-none px-4 text-primary hover:bg-primary hover:text-primary-300  disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer"
                    >
