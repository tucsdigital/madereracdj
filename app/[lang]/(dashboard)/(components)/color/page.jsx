    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          <div className="border border-border rounded w-24">
            <div className="h-12 w-full bg-background  border-b border-border rounded-t"></div>
            <div className="p-2">
          ...
          <div className="border border-border rounded w-24">
            <div className="h-12 w-full bg-secondary-foreground border-b border-border rounded-t"></div>
            <div className="p-2">
              <div className="text-sm font-medium text-default-800 mb-[2px]">
                Dark
              </div>
        ...
        <div className="flex flex-wrap gap-2">
          {primaryColors.map((item, index) => (
            ...
            >
              <div
                className={`h-14 w-full bg-${item.name} border-b border-border min-w-[100px] rounded-t`}
              ></div>
              <div className="p-2">
                <div className="text-sm font-medium text-default-800 mb-[2px]">
                  {item.name}
        ...
        <div className="flex flex-wrap gap-2">
          {defaultColors.map((item, index) => (
            ...
            >
              <div
                className={`h-14 w-full bg-${item.name} border-b border-border rounded-t`}
              ></div>
              <div className="p-2">
                <div className="text-sm font-medium text-default-800 mb-[2px]">
                  {item.name}
