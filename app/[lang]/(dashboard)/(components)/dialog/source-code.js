            ...
            <ScrollArea className="h-full">
              <div className="sm:grid  sm:grid-cols-2 sm:gap-5 space-y-4 sm:space-y-0">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Flatpickr
                    className='w-full border border-border focus:border-primary focus:outline-hidden h-10 rounded-md px-2 placeholder:text-default-600'
      ...
      <DialogContent size="md" >
        ...
        <RadioGroup defaultValue="ux">
          <ul className="space-y-4 w-full">
            <li className="border-2 border-border rounded-sm p-3 group hover:border-primary">
  ...
  return (
    <div className="flex flex-wrap  gap-x-5 gap-y-4 ">
      ...
      <Dialog>
        ...
        <DialogContent overlayClass=" bg-linear-to-b from-background/60 to-primary/30">
          <DialogHeader>
            <DialogTitle className="text-base font-medium ">
              Your modals component has been published
            </DialogTitle>
