...
const IconButton = () => {
  return (
    <React.Fragment>
      ...
      <Button>
        <Icon icon="heroicons:heart-20-solid" className="size-6 mr-2  " />
        Icon Left
      </Button>
      <Button>
        Icon Right Outline
        <Icon icon="heroicons:heart-20-solid" className="size-6 ml-2 " />
      </Button>   
    </React.Fragment>
  )
}
...
const SocialButton = () => {
  return (
    <React.Fragment>
       <Button
        className="w-full hover:opacity-5  text-default-700  hover:text-default-700"
        color="secondary"
        variant="outline"
      >
        <Icon icon="flat-color-icons:google" className="size-6 mr-2" />
        Sign in with Google
      </Button>
      <Button
        className="w-full hover:opacity-5  text-default-700  hover:text-default-700"
      ...
      >
        <Icon
          ...
          className="size-6 mr-2  text-muted-foreground"
        />
        Sign in with Google
      </Button>
      <Button className="bg-[#1877F2] hover:bg-[#1877F2]/90">
        <Icon icon="ic:baseline-facebook" className="size-6 mr-2" />
      ...
      >
        <Icon
          ...
          className="size-6 mr-2  text-[#1877F2]"
        />
        Sign in with Facebook
      </Button>
      <Button
      ...
      <Button color="dark">
        <Icon icon="ic:baseline-apple" className="size-6 mr-2" />
        Sign in with Apple
      </Button>
      <Button
        color="secondary"
   ...
   "
      ...
      <Button className="bg-[#1DA1F2] hover:bg-[#1DA1F2]/90">
        <Icon icon="mdi:twitter" className="size-6 mr-2 " />
      ...
      <Button
        ...
        variant="outline"
      >
        <Icon icon="mdi:twitter" className="size-6 mr-2  text-[#1DA1F2]" />
        Sign in with Twitter
      </Button>
      <Button
        className="w-full hover:opacity-5  text-default-700  hover:text-default-700"
    ...
    <>
      <div className=" flex space-x-3 justify-center ">
        <Button
          size="icon"
          color="secondary"
          className=" rounded-full  hover:opacity-10 "
          variant="outline"
        >
        ...
        <Button
          ...
          variant="outline"
        >
          <Icon icon="ic:round-facebook" className="size-6   " />
        </Button>
      ...
      <div className=" flex space-x-3  justify-center">
        ...
        <Button
          ...
          variant="outline"
        >
          <Icon icon="mdi:twitter" className="size-6 text-[#1DA1F2]   " />
        </Button>
      </div>
      <div className=" flex space-x-3  justify-center">
        <Button
          ...
          variant="outline"
        >
          <Icon icon="ant-design:google-outlined" className="size-6   " />
        </Button>
        <Button
          size="icon"
          color="secondary"
