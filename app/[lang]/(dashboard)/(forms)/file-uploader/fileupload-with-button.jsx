  ...
  return (
    <div className="flex  flex-col gap-5">
      ...
      <div className="flex items-center flex-wrap gap-5">
        <Label htmlFor="circle_file_1" className="h-[68px] w-[68px] rounded-full flex items-center justify-center  border border-border border-dashed cursor-pointer">
          <div>
            <Input type="file" className="hidden" id="circle_file_1" />
            <Upload className="text-default-400" />
          </div>
        </Label>
        <Label htmlFor="circle_file_1" className="h-12 w-12 rounded-full flex items-center justify-center  border border-border border-dashed cursor-pointer">
          <div>
            <Input type="file" className="hidden" id="circle_file_1" />
            <Upload className="text-default-400 h-5 w-5" />
          </div>
        </Label>
        <Label htmlFor="circle_file_1" className="h-9 w-9 rounded-full flex items-center justify-center  bg-default-100 cursor-pointer">
          <div>
            <Input type="file" className="hidden" id="circle_file_1" />
