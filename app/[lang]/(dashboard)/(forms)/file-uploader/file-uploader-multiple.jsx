...
const FileUploaderMultiple = () => {
  ...
  const fileList = files.map((file) => (
    <div
      key={file.name}
      className=" flex justify-between border border-border px-3.5 py-3 my-6 rounded-md "
    >
  ...
  return (
    <Fragment>
      <div {...getRootProps({ className: "dropzone" })}>
        <input {...getInputProps()} />
        <div className=" w-full text-center border-dashed border border-border rounded-md py-[52px] flex  items-center flex-col cursor-pointer">
