      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-4 gap-x-6">
        ...
        <div className="relative">
          ...
          <div className="absolute right-0 top-0 w-20">
            <Select>
              <SelectTrigger className="border-0 focus:outline-hidden focus:ring-0 rounded-none bg-transparent ring-offset-0 focus:ring-offset-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-9 gap-y-5">
        ...
        <div className="relative ">
          <input type="text" id="floatingLabel1"
            className="block  px-3 pb-2.5 pt-6 w-full text-sm text-default-900 border border-border rounded-md appearance-none focus:outline-hidden focus:ring-0  peer" placeholder="" />
          <label htmlFor="floatingLabel1"
            className="absolute text-sm text-default-500  duration-300 transform -translate-y-3.5 scale-75 top-4 z-10 origin-[0] start-2.5 
             ...
             peer-focus:rtl:translate-x-1/4 peer-focus:rtl:left-auto">Username</label>
        </div>
        <div className="relative ">
          <input type="text" id="floatingLabel2"
            className="block  px-3 pb-2.5 pt-6 w-full text-sm text-default-900 border-b  border-border bg-default-100 rounded-t-lg focus:border-primary appearance-none focus:outline-hidden focus:ring-0  peer" placeholder="" />
        ...
        <div className=" py-4">
          <div className='relative'>
            <input type="text" id="floatingLabel3"
              className="block  px-3 py-2.5  w-full text-sm text-default-900 border  appearance-none focus:outline-hidden focus:ring-0  peer" placeholder="" />
        ...
        <div className="py-4">
          <div className='relative'>
            <input type="text" id="floatingLabel4"
              className="block  px-3 h-12  rounded-md w-full text-sm text-default-900 border  appearance-none focus:outline-hidden focus:ring-0  peer" placeholder="" />
