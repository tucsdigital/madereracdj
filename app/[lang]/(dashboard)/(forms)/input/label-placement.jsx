...
const LabelPlacement = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-9 gap-y-5">
      ...
      <div className='border border-border py-2 rounded-md bg-background'>
      ...
      <div className="relative">
        <input type="text" id="floatingLabel1"
          className="block bg-background  px-3 pb-2.5 pt-6 w-full text-sm text-default-900 border border-border rounded-md appearance-none focus:outline-hidden focus:ring-0  peer" placeholder="" />
      ...
      <div className="relative ">
        <input type="text" id="floatingLabel2"
          className="block  px-3 pb-2.5 pt-6 w-full text-sm text-default-900 border-b  border-border bg-default-100 rounded-md focus:border-primary appearance-none focus:outline-hidden focus:ring-0  peer" placeholder="" />
