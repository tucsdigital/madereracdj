      ...
      >
        ...
        <Label htmlFor="rtg_1">
          <div className={cn("min-w-[156px] min-h-[145px] bg-default-100 flex flex-col justify-center items-center rounded-md relative border border-none", {
            ...
            <div className="h-16 w-16">
              <Image src={book1} alt="image" className="size-full object-cover" />
            </div>
        ...
        <Label htmlFor="rtg_2">
          <div className={cn("min-w-[156px] min-h-[145px] bg-default-100 flex flex-col justify-center items-center rounded-md relative border border-none", {
            ...
            <div className="h-16 w-16">
              <Image src={book2} alt="image" className="size-full object-cover" />
            </div>
        ...
        <Label htmlFor="rtg_3">
          <div className={cn("min-w-[156px] min-h-[145px] bg-default-100 flex flex-col justify-center items-center rounded-md relative border border-none", {
            ...
            <div className="h-16 w-16">
              <Image src={book3} alt="image" className="size-full object-cover" />
            </div>
        ...
        <Label htmlFor="rtg_4">
          <div className={cn("min-w-[156px] min-h-[145px] bg-default-100 flex flex-col justify-center items-center rounded-md relative border border-none", {
            ...
            <div className="h-16 w-16">
              <Image src={book4} alt="image" className="size-full object-cover" />
            </div>
        ...
        <Label htmlFor="rtg_5">
          <div className={cn("min-w-[156px] min-h-[145px] bg-default-100 flex flex-col justify-center items-center rounded-md relative border border-none", {
            ...
            <div className="h-16 w-16">
              <Image src={book5} alt="image" className="size-full object-cover" />
            </div>
        ...
        <Label htmlFor="rtg_6">
          <div className={cn("min-w-[156px] min-h-[145px] bg-default-100 flex flex-col justify-center items-center rounded-md relative border border-none", {
            ...
            <div className="h-16 w-16">
              <Image src={book6} alt="image" className="size-full object-cover" />
            </div>
