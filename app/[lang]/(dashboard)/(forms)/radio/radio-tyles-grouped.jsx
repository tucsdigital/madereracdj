    ...
    <div>
      ...
      <RadioGroup defaultValue="rtg_1" onValueChange={handleValueChange}>
        <Label htmlFor="rtg_1">
          <div
            className={cn(
              "min-w-[156px] min-h-[145px] bg-default-100 dark:bg-default-200 flex flex-col justify-center items-center rounded-md relative border border-none cursor-pointer",
              {
