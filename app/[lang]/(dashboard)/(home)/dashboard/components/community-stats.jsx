    ...
    <Card className="relative rounded-3xl shadow-2xl border border-border overflow-hidden bg-card">
      ...
      <CardContent className="relative pt-2 px-6 pb-6">
        <div className="space-y-4">
          <div className="p-5 rounded-2xl bg-blue-500/10 border border-blue-500/20 shadow-xl backdrop-blur-sm">
          ...
          <div className="p-5 rounded-2xl bg-card/60 border border-border/60 shadow-lg backdrop-blur-sm transition-all hover:scale-[1.01]">
            <div className="flex items-center gap-3 mb-2">
