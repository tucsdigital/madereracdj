...
export default function WinnersCard({ yesterdayWinners }: WinnersCardProps) {
  if (!yesterdayWinners || yesterdayWinners.length === 0) {
    return (
      ...
      <Card className="relative rounded-3xl shadow-2xl border-0 overflow-hidden bg-gradient-to-br from-indigo-50/80 via-purple-50/60 to-pink-50/80  h-full flex flex-col">
