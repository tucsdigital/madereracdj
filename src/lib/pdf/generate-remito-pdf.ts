...
export function buildRemitoHtml(
  ...
  const fechaEntrega = envio?.fechaEntrega || null;
  ...
  const empleadoEnvioHtml = (() => {
    ...
    const fechaEntregaEmpleado = safe(envio?.fechaEntrega || "", "");
    const rangoHorarioEmpleado = safe(envio?.rangoHorario || "", "");
      ...
      <div class="header">
        <div class="header-left">
          ...
          <div class="header-empresa">
            ...
            <div class="telefono">Tel: ${safe(empresa.telefono, "1178971517")}</div>
        ...
        <table class="products-table">
          <thead>
            <tr>
              ...
              <th class="text-center" style="width: 12.5%;">CANTEADO</th>
              ${!paraEmpleado ? `
