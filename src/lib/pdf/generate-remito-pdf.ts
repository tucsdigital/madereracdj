...
export function buildRemitoHtml(remito: RemitoModel, paraEmpleado: boolean = false, autoPrint: boolean = false): string {
  ...
  const itemsHtml = items.length > 0
        ...
        .map(
          ...
          <tr>
            ...
            <td style="padding: 4px 6px; text-align: center; font-weight: 800; color: #000000; font-size: 12px;">
              ...
              ${item.medidaValor !== undefined && item.medidaUnidad ? `<div style="margin-top: 1px; font-size: 9.5px; font-weight: 700; color: #111827;">${formatNumber(item.medidaValor)} ${escapeHtml(String(item.medidaUnidad))}</div>` : ""}
            </td>
            ...
            <td style="padding: 4px 6px; text-align: right; font-weight: 800; color: #000000; font-size: 11.5px;">${formatNumber(Number(item.descuento || 0))}%</td>
            ...
            <td style="padding: 4px 6px; text-align: right;" class="descuento-empleado"></td>
    ...
    : `
      <tr>
        <td colspan="${paraEmpleado ? 4 : 7}" style="padding: 6px 8px; text-align: center; color: #000000; font-weight: 700;">
          Sin productos
        </td>
      </tr>
    `;
  ...
  // No agregar si hay muchos items (Puppeteer manejará el overflow automáticamente)
    ...
    if (items.length > 0 && items.length < 8) {
      ...
      <tr>
        ...
        <td style="padding: 4px 6px;" class="descuento-empleado"></td>
        ...
        <table class="products-table">
          <thead>
            <tr>
              ...
              <th class="text-right" style="width: 12.5%;">DESCUENTO</th>
              <th class="text-right" style="width: 17.5%;">SUBTOTAL</th>
              ` : `
              <th class="text-right precio-empleado" style="width: 15%;"></th>
              <th class="text-right descuento-empleado" style="width: 12.5%;"></th>
