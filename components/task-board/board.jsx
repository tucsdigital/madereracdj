  ...
  return (
    <>
      ...
      >
        <CardHeader
          {...listeners}
          className="flex-row items-center mb-0 justify-between border-b border-border rounded-sm py-2.5 space-y-0 px-3"
        >
          <div className="flex items-center">
            <Button
              type="button"
              size="icon"
              className="w-5 h-5 bg-transparent text-primary/80 border border-border rounded-sm hover:bg-transparent"
            >
