  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="relative pr-1.5">
      ...
      <Input
        ...
        {...register("title")}
        className={cn(
          "h-[52px] rounded-none border-b border-border pl-12 text-sm font-medium text-default-600 focus:shadow-sm focus:drop-shadow-xs focus:inset-4 focus:border-default-300",
          {
