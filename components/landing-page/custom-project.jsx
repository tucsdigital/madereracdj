...
const CustomProject = () => {
  ...
  return (
    <section
      className="py-16 2xl:py-[120px] bg-linear-to-r from-[#E8EAF3] via-[#E1EDF4] to-pink-[#EFE8F0] dark:from-transparent dark:via-transparent dark:to-transparent dark:bg-card overflow-hidden"
      id="custom"
    >
