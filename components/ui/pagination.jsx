...
const paginationVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-0   disabled:opacity-50  disabled:cursor-not-allowed ",
  {
    variants: {
      color: {
      ...
      variant: {
        ...
        soft: "text-current opacity-10  hover:text-primary-foreground",
