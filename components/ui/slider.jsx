...
const sliderVariants = cva(
  "relative flex w-full touch-none select-none  items-center   data-disabled:opacity-50 data-[orientation=vertical]:w-2 data-[orientation=vertical]:h-full  data-[orientation=vertical]:flex-col   ",
  {
    variants: {
      color: {
        primary:
          "[&_.range]:bg-primary  [&_.range-thumb]:border-secondary [&_.range-thumb]:drop-shadow-xs [&_.range-thumb]:bg-primary  [&_.range-thumb]:focus-visible:bg-primary",
                ...
                <TooltipProvider disableHoverableContent>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <SliderPrimitive.Thumb className="block h-5 w-5 cursor-pointer rounded-full range-thumb" />
                    </TooltipTrigger>
