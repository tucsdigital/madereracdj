              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <label>
                    ...
                    <div
                      className={cn(
                        "flex h-9 w-9 items-center justify-center rounded-full  border-2 border-solid text-xs cursor-pointer",
                        isActive
                          ? "border-primary!"
                          : "border-transparent!"
                      )}
                ...
                <TooltipContent
                  align="center"
                  className="rounded-[0.5rem] bg-zinc-900 text-zinc-50  capitalize border-transparent!"
                >
                  {value}
                </TooltipContent>
              </Tooltip>
