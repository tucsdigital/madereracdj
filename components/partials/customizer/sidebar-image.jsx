  ...
  return (
    ...
    >
      ...
      <div className=" grid grid-cols-7 gap-3">
        <button
          onClick={handleClear}
          className=" h-[72px] border border-border flex items-center justify-center rounded text-default-400 cursor-pointer"
        >
          {sidebarBg === "none" ? (
        ...
        {selectedFiles.map((file, index) => (
          <button
            ...
            className={cn(
              " h-[72px] rounded relative bg-cover bg-no-repeat   bg-blend-multiply cursor-pointer",
              {
        ...
        <label className=" h-[72px] rounded border border-border bg-border  flex items-center justify-center text-muted-foreground cursor-pointer">
