  ...
  return (
    <>
      <div className="main-sidebar  pointer-events-none fixed start-0 top-0 z-60 flex h-full xl:z-10 print:hidden">
        <div
          className={cn(
            "border-border  dark:border-default-300 pointer-events-auto relative z-20 flex h-full w-[72px] flex-col border-r border-dashed   bg-card transition-all duration-300",
            {
              "ltr:-translate-x-full rtl:translate-x-full xl:ltr:translate-x-0  xl:rtl:translate-x-0":
                !collapsed && subMenu,
        ...
        <div
          className={cn(
            "border-border pointer-events-auto relative z-10 flex flex-col h-full w-[228px] border-r  bg-card   transition-all duration-300",
            {
