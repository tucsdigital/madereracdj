...
export const DEFAULT_RECIBO_TEMPLATE = {
  ...
  bodyHtml: [
    ...
    "<li>Ha sido debidamente informado por el personal de Maderas Caballero sobre los cuidados específicos y el plan de mantenimiento preventivo que requiere la estructura (aplicación de protectores, limpieza de superficies, frecuencia de pintado/aceitado, etc.).</li>",
    ...
    "<div>La garantía cubre defectos de instalación y vicios ocultos de los materiales, quedando sujeta a las condiciones de uso y mantenimiento informadas por la empresa.<br><br>La misma quedará sin efecto en caso de intervención por terceros ajenos a Maderas Caballero o por incumplimiento de las recomendaciones brindadas.</div>",
    "</div>",
  ].join(""),
  legalHtml: [
