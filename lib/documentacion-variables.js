...
export const DEFAULT_RECIBO_TEMPLATE = {
  ...
  bodyHtml: [
    ...
    "<div>La garantía cubre defectos de instalación y vicios ocultos de los materiales, pero quedará sin efecto si el Cliente no cumple con el mantenimiento informado o si la estructura es intervenida por terceros ajenos a la empresa.</div>",
    "</div>",
  ].join(""),
  legalHtml: [
